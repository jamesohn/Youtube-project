    ...
    for (const page of pageList){
      ...
      if (body !== undefined && body.items !== undefined){
        for (const item of body.items){
          if (item !== undefined && item.snippet.topLevelComment.snippet.authorChannelId.value !== undefined){
            authorChannelId_list.push(item.snippet.topLevelComment.snippet.authorChannelId.value)
            // console.log(authorChannelId_list);
