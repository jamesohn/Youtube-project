const fs = require('fs'),
  path = 'C:/Users/이세령/Desktop/Youtube-project/Youtube-project/locale_Test'
let cum = 0;
let num = 0;

let files = fs.readdirSync(path,'utf8');
for (let file of files) {
  let content = fs.readFile(`${path}/${file}`,'utf8',function(err,data) {
    ...
    try {
      ...
      let new_path = 'C:/Users/이세령/Desktop/Youtube-project/Youtube-project/locale_Test2'
      fs.writeFileSync(`${new_path}/${channel}.txt`,JSON.stringify(data2),'utf8')
